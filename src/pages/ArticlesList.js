        ...
        <div key={index} className="p-4 md:w-1/2">
          <div className="h-full border-2 border-gray-200 
            ...
            <Link to ={`/article/${article.name}`}>
              <img className="lg:h-48 md:h-36 w-full object-cover 
              object-center" 
            ...
            <div className="p-6">
              <Link key={index} to={`/article/${article.name}`}>
                <h3 className='text-lg font-medium text-grey-90 mb-1'>
                {article.title}
                </h3>
              </Link>
              ...
              {/* learn more */}
              <div className='flex item-center flex-wrap mb-3'>
